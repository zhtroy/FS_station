...
#define __TI_FINSH_EXPORT_FUNCTION(f)  PRAGMA(DATA_SECTION(f,".shellCommand"))
#define __TI_FINSH_EXPORT_VAR(v)       PRAGMA(DATA_SECTION(v,".shellVariable"))
#endif
...
#define     SHELL_EXPORT_CMD(cmd, func, desc)                               \
            __TI_FINSH_EXPORT_FUNCTION(shellCommand##cmd);                  \
            const char shellCmd##cmd[] = #cmd;                              \
            const char shellDesc##cmd[] = #desc;                            \
            const SHELL_CommandTypeDef shellCommand##cmd =                  \
            {                                                               \
                shellCmd##cmd,                                              \
                (int (*)())func,                                            \
                shellDesc##cmd,                                             \
...
#define     SHELL_EXPORT_CMD_EX(cmd, func, desc, help)                      \
    ...
    #define SHELL_EXPORT_VAR(var, variable, desc, type)                     \
            __TI_FINSH_EXPORT_VAR(shellVariable##var);                 \
...
#define     MSH_CMD_EXPORT(cmd, desc)   \
            SHELL_EXPORT_CMD(cmd, cmd, desc)
#define     MSH_CMD_EXPORT_EX(cmd, desc, help)   \
            SHELL_EXPORT_CMD_EX(cmd, cmd, desc, help)
