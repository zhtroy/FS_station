...
Msg const *HsmTest_top(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case START_EVT:
        printf("top-INIT;");
...
Msg const *HsmTest_s1(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case START_EVT:
        printf("s1-INIT;");
...
Msg const *HsmTest_s11(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case ENTRY_EVT:
        printf("s11-ENTRY;");
        return 0;
...
Msg const *HsmTest_s2(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case START_EVT:
        printf("s2-INIT;");
...
Msg const *HsmTest_s21(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case START_EVT:
        printf("s21-INIT;");
...
Msg const *HsmTest_s211(HsmTest *me, Msg *msg) {
    switch (msg->evt) {
    case ENTRY_EVT:
        printf("s211-ENTRY;");
        return 0;
